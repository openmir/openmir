...
<meta content="qf3cwJMLSIQopplwHqQlDAawBBWHQAHnZyvl7WI1VLk=" name="csrf-token" />
  ...
  <input type="text" data-hotkey="/ s" name="q" id="js-command-bar-field" placeholder="Search or type a command" tabindex="1" data-username="sness" autocapitalize="off">
  ...
  <input type="hidden" name="ref" value="cmdform">
    ...
    <input type="hidden" class="js-repository-name-with-owner" value="LearnBoost/socket.io"/>
    <input type="hidden" class="js-repository-branch" value="master"/>
    <input type="hidden" class="js-repository-tree-sha" value="0f0d16789e830e520fcf6540cd091fad3d244562"/>
  ...
  <div class="divider-vertical"></div>
    ...
    <ul id="user-links">
      <li>
        <a href="https://github.com/sness" class="name">
          <img height="20" src="https://secure.gravatar.com/avatar/70aa9d11472b36ecba919702631e8db1?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="20" /> sness
        </a>
      </li>
...
<div class="js-new-dropdown-contents hidden">
  <ul class="dropdown-menu">
    ...
    <li>
        <a href="https://github.com/LearnBoost/socket.io/issues/new"><span class="mini-icon mini-icon-issue-opened"></span> New issue</a>
    </li>
    <li>
    </li>
    <li>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="qf3cwJMLSIQopplwHqQlDAawBBWHQAHnZyvl7WI1VLk=" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="557980" />
    ...
    <li class="js-toggler-container js-social-container starring-container ">
      ...
      <a class="social-count js-social-count" href="/LearnBoost/socket.io/stargazers">8,100</a>
    </li>

        <li>
          <a href="/LearnBoost/socket.io/fork" class="minibutton js-toggler-target fork-button lighter upwards" title="Fork this repo" rel="nofollow" data-method="post">
            <span class="mini-icon mini-icon-branch-create"></span>
            <span class="text">Fork</span>
          </a>
          <a href="/LearnBoost/socket.io/network" class="social-count">1,179</a>
        </li>
  ...
  <ul class="tabs">
      <li class="pulse-nav"><a href="/LearnBoost/socket.io/pulse" highlight="pulse" rel="nofollow"><span class="mini-icon mini-icon-pulse"></span></a></li>
    ...
    <li><a href="/LearnBoost/socket.io/pulls" highlight="repo_pulls">Pull Requests <span class='counter'>65</span></a></li>

      <li><a href="/LearnBoost/socket.io/issues" highlight="repo_issues">Issues <span class='counter'>455</span></a></li>
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
          <li><a href="/LearnBoost/socket.io/tags" class="tabnav-tab" highlight="repo_tags">Tags <span class="counter ">75</span></a></li>
    </ul>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item js-navigation-target ">
                  <span class="select-menu-item-icon mini-icon mini-icon-confirm"></span>
                  <a href="/LearnBoost/socket.io/blob/0.9.14/client/socket.io.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="0.9.14" rel="nofollow" title="0.9.14">0.9.14</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item js-navigation-target ">
                  <span class="select-menu-item-icon mini-icon mini-icon-confirm"></span>
  ...
  <ul class="tabnav-tabs">
    ...
    <li><a href="/LearnBoost/socket.io/branches" class="tabnav-tab" highlight="repo_branches" rel="nofollow">Branches <span class="counter ">8</span></a></li>
  </ul>
...
<div id="slider">
  ...
  <div class="commit file-history-tease">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/LearnBoost/socket.io/blob/64f6b244b6bd79880ba2e0ba00778a2309b39d0b/client/socket.io.js" data-title="socket.io/client/socket.io.js at master · LearnBoost/socket.io · GitHub" data-type="blob">
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.08485s from fe4.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.08536' data-host='fe4'></span>
